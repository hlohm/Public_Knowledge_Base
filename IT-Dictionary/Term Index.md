...
The live term count is the [[Term Dashboard]] — **715 terms** as of this edit (it counts every note with `type: term`). The A–Z below is a hand-browsable snapshot; when it drifts from the dashboard, rebuild it exactly by running `tools/gen_term_index.py`. Below the A–Z: a per-branch backlog of high-value terms still worth adding — a checklist toward fuller coverage, not a contract.

## A–Z (existing terms)

*Generated by `tools/gen_term_index.py` — do not hand-edit. The live count is [[Term Dashboard]] (`type: term`).*

**A** — [[A Record]] · [[AAA]] · [[ABAC]] · [[ABI]] · [[Abstraction]] · [[Access Control Matrix]] · [[Accessibility]] · [[ACID]] · [[ACL]] · [[ACME]] · [[Active Directory]] · [[Adversary Emulation]] · [[AI Agent]] · [[Air Gap]] · [[ALU]] · [[Ambient Authority]] · [[Antivirus]] · [[API]] · [[AppArmor]] · [[Application Allowlisting]] · [[APT]] · [[ARP]] · [[Array]] · [[ASCII]] · [[Assertion]] · [[Asset]] · [[AST]] · [[Asymmetric Encryption]] · [[Async-Await]] · [[Attack Surface]] · [[Attention]] · [[Audit]] · [[Authentication]] · [[Authoritative DNS Server]] · [[Authorization]]
